    ...
    return (
        <div className='Home bg-[#09002B] bg-background flex flex-col text-white font-exo w-full'>
            ...
            <div className='flex justify-center items-center'>
                <div className='w-full max-w-[1280px] pt-40 px-[50px]'>
                    <img src={`${slides[currentIndex].url}`} alt='Level Banner' />
                    <div class="bg-gradient-to-r from-[#FFA9C5] to-[#FF3073]/50 p-[2px] w-fit absolute translate-x-[70%] -translate-y-[280%]">
                        <div>
