    ...
    return (
        <div className='Level01Intro flex flex-col text-white font-exo w-full'>
                            ...
                            <div>
                                {
                                    authUser === null
                                        ...
                                        currentUserSkillLength === 0 ?
                                            <button onClick={() => navigate(`/battle/level01/${currentUserDataSet[1]}`)} className='text-sm sm:text-sm md:text-[22px] lg:text-md w-full h-[3rem] sm:h-[3rem] md:h-[5rem] lg:h-[5rem] bg-[#371152] duration-200 hover:bg-[#541680] border-gradient-to-br from-[#FC6DFF] to-[#9900ff]/30 uppecase font-extrabold'>Start Game</button>
                                            :
                                            <button onClick={() => navigate(`/battle/level01/${currentUserDataSet[1]}${currentUserSkillSet}`)} className='text-sm sm:text-sm md:text-[22px] lg:text-md w-full h-[3rem] sm:h-[3rem] md:h-[5rem] lg:h-[5rem] bg-[#371152] duration-200 hover:bg-[#541680] border-gradient-to-br from-[#FC6DFF] to-[#9900ff]/30 uppecase font-extrabold'>Start Game</button>
                                }
            ...
            <div className='flex flex-col justify-center items-center'>
                ...
                <div className='hidden sm:hidden md:grid lg:grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-[50px] sm:gap-[50px] lg:gap-[150px] mb-[5rem]'>
