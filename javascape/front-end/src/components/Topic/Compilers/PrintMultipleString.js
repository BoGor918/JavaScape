    ...
    return (
        <div className='Forum flex flex-col text-white font-exo w-full'>
            ...
            <div className='w-full overflow-auto flex flex-col items-center'>
                {/* Back Button */}
                <div className="w-full max-w-[20.88rem] sm:max-w-[20.88rem] md:max-w-[44.9rem] lg:max-w-[85.9rem] pb-5 flex justify-start">
                ...
                <div className='w-full flex flex-col sm:flex-col md:flex-col lg:flex-row justify-center items-center sm:items-center md:items-center lg:items-start'>
                    {/* Description Panel */}
                    <div className='flex flex-col p-5 mr-0 sm:mr-0 md:mr-0 lg:mr-4 mb-4 sm:mb-4 md:mb-4 lg:mb-0 max-w-[21rem] sm:max-w-[21rem] md:max-w-[45rem] lg:max-w-[30rem] w-full rounded-2xl border-2 bg-gradient-to-br from-[#FC6DFF] to-[#9900ff]/30 py-5'>
                        <span className='font-bold underline self-center'>Description - Click To Copy</span>
                        <CopyToClipboard text={`System.out.println("Hello World!");\nSystem.out.println("I am learning Java.");\nSystem.out.println("It is awesome!");`} onCopy={() => setCopied(true)}>
