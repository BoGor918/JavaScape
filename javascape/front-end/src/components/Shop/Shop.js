                        ...
                        <div className='Topic flex flex-col text-white font-exo w-full'>
                            ...
                            <div className='w-full overflow-auto flex flex-col items-center mb-[7rem] sm:mb-[7rem] md:mb-[10rem] lg:mb-[10rem]'>
                                ...
                                <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[50px] sm:gap-[50px] md:gap-[100px] lg:gap-[100px]'>
                                    <NavLink to="/ability?ability=damage-x2"><img src={DamageX2} alt="" className='w-full max-w-[300px] lg:hover:max-w-[310px] lg:duration-200 cursor-pointer' /></NavLink>
                                    <NavLink to="/ability?ability=health-x2"><img src={HealthX2} alt="" className='w-full max-w-[300px] lg:hover:max-w-[310px] lg:duration-200 cursor-pointer' /></NavLink>
